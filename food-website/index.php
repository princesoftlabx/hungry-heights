        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10">
                 ...
                 <a href="./cart.html?cartData=" class="header-btn header-cart" id="cartButton">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                     <button class="dish-add-btn"
                                                        onclick="addToCart({ id: 1, title: 'Fresh Chicken Veggies', price: 499, type: 'Non Veg', image: 'assets/images/dish/1.png' })">
                                    ...
                                    <div class="dish-box text-center">
                                        ...
                                        <div class="dist-bottom-row">
                                            <ul>
                                                ...
                                                <li>
                                                    <button class="dish-add-btn"
                                                        onclick="addToCart({ id: 2, title: 'Grilled Chicken', price: 359, type: 'Non Veg', image: 'assets/images/dish/2.png' })">
                                                        <i class="uil uil-plus"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="dish-box text-center">
                                        ...
                                        <div class="dist-bottom-row">
                                            <ul>
                                                ...
                                                <li>
                                                    <button class="dish-add-btn"
                                                        onclick="addToCart({ id: 3, title: 'Panner Noodles', price: 149, type: 'Veg', image: 'assets/images/dish/3.png' })">
                                                        <i class="uil uil-plus"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="dish-box text-center">
                                        ...
                                        <div class="dist-bottom-row">
                                            <ul>
                                                ...
                                                <li>
                                                 <button class="dish-add-btn"
                                                        onclick="addToCart({ id: 4, title: 'Chicken Noodles', price: 379, type: 'Non Veg', image: 'assets/images/dish/4.png' })">
                                                        <i class="uil uil-plus"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="dish-box text-center">
                                        ...
                                        <div class="dist-bottom-row">
                                            <ul>
                                                ...
                                                <li>
                                                     <button class="dish-add-btn"
                                                        onclick="addToCart({ id: 5, title: 'Bread Boiled Egg', price: 99, type: 'Non Veg', image: 'assets/images/dish/5.png' })">
                                                        <i class="uil uil-plus"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="dish-box text-center">
                                        ...
                                        <div class="dist-bottom-row">
                                            <ul>
                                                ...
                                                <li>
                                                    <button class="dish-add-btn"
                                                        onclick="addToCart({ id: 6, title: 'Immunity Dish', price: 159, type: 'Veg', image: 'assets/images/dish/6.png' })">
                                                        <i class="uil uil-plus"></i>
                                                    </button>
                                                </li>
                                            </ul>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        ...
                                        <h3 class="h3-title">Hunter King</h3>
                                        <div class="social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#"><i class="uil uil-facebook-f"></i></a>
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <div class="copyright-text">
                                    <p>Copyright &copy; 2023 <span class="name">Aditya Sangwan.</span>All Rights
                                        Reserved.
                                    </p>
                                </div>
                            </div>
...
function addToCart(dish) {
    ...
    const foundItem = existingItems.find((item) => item.id === dish.id);

    if (foundItem) {
        foundItem.quantity++;
    } else {
        existingItems.push({ ...dish, quantity: 1 });
    }
...
function updateCartNumber() {
    ...
    cartNumberElement.textContent = totalQuantity.toString();
}
